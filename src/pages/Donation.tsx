...
const Donation = () => {
  ...
  useEffect(() => {
    const PAYPAL_SRC = "https://www.paypal.com/sdk/js?client-id=BAApZa13UAQjwvN30iIJdTy78256Dr3lT4ZuFsoCg8JnK7JUmENbhID3F-2QxBzNux6rePh0t2_6O_pqe4&components=hosted-buttons&disable-funding=venmo&currency=USD";
